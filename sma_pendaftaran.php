  ...
  <ul class="nav nav-pills">
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        ...
        <a class="dropdown-item" href="ppdb_sma">PPDB MI</a></div>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="sma_jadwal">Jadwal</a>
    </li>
    <li class="nav-item">
      <a class="nav-link " href="sma_pendaftaran">Daftar Online</a>
    </li>
  </ul>
  <hr>
  <!-- Tab panes -->
                                ...
                                <div class="col-lg-12">
                                    <form role="form">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label>NISN</label>
                                            <input class="form-control" placeholder="contoh=9982123488">
                                            <p class="help-block">Isi 10 digit ngka NISN</p>
                                        </div>
                                         <div class="form-group">
                                            <label>NIK</label>
                                        ...
                                        <hr>
                                        <h4>E. KELENGKAPAN PERSYARATAN</h4>
                                        <br>

                                        <div class="form-group">
                                            <label>Berkas persyaratan yang dilampirkan</label>
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="">Asli SKHUN / SKHUN Sementara
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="">Fotocopy Ijazah / STTB
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="">Fotocopy Raport Sementara
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="">Pas Photo 3 x 4
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="">Surat Keterangan dari Kepala Sekolah
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="">Setifikat / Piagam
                                                </label>
                                            </div>
                                        </div>
                                        <hr>
                                        <h4>F. PEMINATAN JURUSAN</h4>
                                        <br>

                                        <div class="form-group">
                                            <label>Peminatan Jurusan </label>
                                            <input class="form-control">
                                        </div>
